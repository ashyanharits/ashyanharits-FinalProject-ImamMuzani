            ...
            <div class="card border-0 shadow-sm rounded-3 bg-success text-white h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h2 class="fw-bold mb-0"><?php echo e($totalKelas); ?></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 bg-info text-white h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h2 class="fw-bold mb-0"><?php echo e($santriBaru); ?></h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 gap-3">
        ...
        <div class="d-flex gap-2">
            <div class="btn-group shadow-sm" role="group">
                <button wire:click="$set('viewMode', 'list')" type="button" class="btn btn-<?php echo e($viewMode == 'list' ? 'primary' : 'light'); ?>">
                    <i class="bi bi-list-ul"></i>
                </button>
                <button wire:click="$set('viewMode', 'grid')" type="button" class="btn btn-<?php echo e($viewMode == 'grid' ? 'primary' : 'light'); ?>">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $santris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $santri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="ps-4">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-circle bg-primary text-white me-3 rounded-circle d-flex align-items-center justify-content-center fw-bold" style="width: 40px; height: 40px;">
                                            <?php echo e(substr($santri->nama, 0, 1)); ?>

                                        </div>
                                        <div>
                                            <div class="fw-bold text-dark"><?php echo e($santri->nama); ?></div>
                                            <small class="text-muted">ID: <?php echo e($santri->id); ?></small>
                                        </div>
                                    </div>
                                </td>
                                <td><span class="badge bg-light text-dark border"><?php echo e($santri->kelas); ?></span></td>
                                <td><?php echo e($santri->no_hp ?? '-'); ?></td>
                                <td>
                                    <?php if($santri->tanggal_lahir): ?>
                                        <?php echo e(\Carbon\Carbon::parse($santri->tanggal_lahir)->format('d M Y')); ?>
                                ...
                                <td>
                                    <span class="d-inline-block text-truncate" style="max-width: 150px;" title="<?php echo e($santri->alamat); ?>">
                                        <?php echo e($santri->alamat ?? '-'); ?>

                                    </span>
                                </td>
                                <td class="text-end pe-4">
                                    <button wire:click="showDetail(<?php echo e($santri->id); ?>)" class="btn btn-sm btn-light text-primary me-1" title="Detail">
                                        <i class="bi bi-eye"></i>
                                    </button>
                                    <button wire:click="edit(<?php echo e($santri->id); ?>)" class="btn btn-sm btn-light text-warning me-1" title="Edit">
                                        <i class="bi bi-pencil"></i>
                                    </button>
                                    <button onclick="confirm('Yakin hapus?') || event.stopImmediatePropagation()" wire:click="delete(<?php echo e($santri->id); ?>)" class="btn btn-sm btn-light text-danger" title="Hapus">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="card border-0 shadow-sm h-100 rounded-3 position-relative overflow-hidden santri-card">
                        <div class="card-body text-center p-4">
                            ...
                            <h5 class="fw-bold mb-1"><?php echo e($santri->nama); ?></h5>
                            <p class="text-muted mb-3"><?php echo e($santri->kelas); ?></p>
                            ...
                            <div class="d-flex justify-content-center gap-2">
                                <button wire:click="showDetail(<?php echo e($santri->id); ?>)" class="btn btn-outline-primary btn-sm rounded-pill px-3">Detail</button>
                                <button wire:click="edit(<?php echo e($santri->id); ?>)" class="btn btn-outline-secondary btn-sm rounded-circle"><i class="bi bi-pencil"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg rounded-4">
                    <div class="modal-header border-bottom-0 pb-0">
                        <h5 class="modal-title fw-bold"><?php echo e($santri_id ? 'Edit Data Santri' : 'Tambah Santri Baru'); ?></h5>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-6">
                                    ...
                                    <select wire:model="kelas" class="form-select <?php $__errorArgs = ['kelas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" wire:model="no_hp" class="form-control <?php $__errorArgs = ['no_hp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if($isDetailOpen && $selectedSantri): ?>
        <div class="modal fade show d-block" style="background-color: rgba(0,0,0,0.5);" tabindex="-1">
                        ...
                        <div class="row g-0">
                            <div class="col-md-4 bg-light p-4 text-center border-end">
                                <div class="avatar-circle bg-white text-primary mx-auto mb-3 rounded-circle d-flex align-items-center justify-content-center display-4 fw-bold shadow-sm" style="width: 100px; height: 100px;">
                                    <?php echo e(substr($selectedSantri->nama, 0, 1)); ?>

                                </div>
                                <h5 class="fw-bold mb-1"><?php echo e($selectedSantri->nama); ?></h5>
                                <p class="text-muted mb-3"><?php echo e($selectedSantri->kelas); ?></p>
                                <hr>
                                <div class="text-start small">
                                    <p class="mb-2"><i class="bi bi-telephone me-2 text-muted"></i> <?php echo e($selectedSantri->no_hp ?? '-'); ?></p>
                                    <p class="mb-2"><i class="bi bi-geo-alt me-2 text-muted"></i> <?php echo e($selectedSantri->alamat ?? '-'); ?></p>
                                    <p class="mb-0"><i class="bi bi-calendar me-2 text-muted"></i> <?php echo e($selectedSantri->tanggal_lahir ? \Carbon\Carbon::parse($selectedSantri->tanggal_lahir)->format('d M Y') : '-'); ?></p>
                                </div>
                            </div>
                            <div class="col-md-8 p-4">
                                <h6 class="fw-bold text-uppercase text-muted mb-3">Riwayat Hafalan Terakhir</h6>
                                <div class="list-group list-group-flush">
                                    <?php $__empty_1 = true; $__currentLoopData = $selectedSantri->hafalan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="list-group-item px-0 py-3">
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                <span class="fw-bold text-primary"><?php echo e($h->nama_hafalan); ?> : <?php echo e($h->ayat); ?></span>
                                                <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($h->tanggal)->diffForHumans()); ?></small>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <small class="text-muted fst-italic"><?php echo e($h->catatan_ustadz ?? 'Tidak ada catatan'); ?></small>
                                                <span class="badge bg-<?php echo e($h->status == 'lancar' ? 'success' : ($h->status == 'selesai' ? 'primary' : 'warning')); ?> rounded-pill"><?php echo e(ucfirst($h->status)); ?></span>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php /**PATH C:\xampp\ImamMuzani\resources\views/livewire/ustadz/santri.blade.php ENDPATH**/ ?>