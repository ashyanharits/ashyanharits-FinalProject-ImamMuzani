...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?php echo e(route('admin.santri.create')); ?>" class="btn btn-primary shadow-sm">
...
<div class="alert alert-info py-2 mb-3 shadow-sm d-flex justify-content-between align-items-center">
    <div>
        ...
        Total Santri Terdaftar: <strong id="total-count"><?php echo e($santri->total()); ?></strong>
    </div>
                ...
                <table class="table table-bordered table-striped align-middle text-center">
                    ...
                    <tbody id="santriTable">
                        <?php $__currentLoopData = $santri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($index + $santri->firstItem()); ?></td>
                                <td class="fw-semibold text-start santri-nama">
                                    <i class="bi bi-person-circle text-primary me-1"></i>
                                    <span class="santri-text"><?php echo e($s->nama); ?></span>
                                </td>
                                <td><?php echo e($s->kelas ?? '-'); ?></td>
                                <td><?php echo e($s->alamat ?? '-'); ?></td>
                                <td><?php echo e($s->no_hp ?? '-'); ?></td>
                                <td>
                                    <a href="<?php echo e(route('admin.santri.edit', $s->id)); ?>" class="btn btn-warning btn-sm">
                                        <i class="bi bi-pencil-square"></i> Edit
                                    </a>
                                    <form action="<?php echo e(route('admin.santri.destroy', $s->id)); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const totalCount = <?php echo e($santri->total()); ?>;
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\ImamMuzani\resources\views/admin/santri/index.blade.php ENDPATH**/ ?>