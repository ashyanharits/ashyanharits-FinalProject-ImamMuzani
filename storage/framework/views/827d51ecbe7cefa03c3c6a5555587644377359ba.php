...
<div class="min-h-screen flex flex-col bg-gradient-to-b from-amber-50 to-white font-sans">
    ...
    <nav class="fixed w-full bg-white shadow-md z-50 border-b border-amber-100">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            <div class="flex items-center space-x-3">
                <img src="<?php echo e(asset('images/logoremove.png')); ?>" alt="Logo" class="w-10 h-10">
            ...
            <div class="hidden md:flex space-x-6 text-sm font-medium">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    ?>
                    <a href="<?php echo e($dashboardUrl); ?>" class="text-[#C57A00] font-semibold">Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="hover:text-[#C57A00] transition">Login</a>
                    <a href="<?php echo e(route('register')); ?>" class="hover:text-[#C57A00] transition">Register</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
    ...
    <section id="beranda" class="flex flex-col justify-center items-center text-center pt-40 pb-24 px-6 bg-gradient-to-b from-white to-amber-50">
        <img src="<?php echo e(asset('images/logoremove.png')); ?>" alt="Logo Madrasah" class="w-28 h-28 mb-6 animate-fade-in">
    ...
    <footer class="text-center py-6 bg-[#5C3A00] text-white text-sm">
        <p>&copy; <?php echo e(date('Y')); ?> Madrasah Imam Muzani. Semua Hak Cipta Dilindungi.</p>
    </footer>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\ImamMuzani\resources\views/welcome.blade.php ENDPATH**/ ?>